...
<html lang="pt-br">
    ...
    <body>
        <table width="50%" cellspacing="1" cellspacing="2" border="0" bgcolor="#047AC4" align="center">
                <tr>
                ...
                <tr>
                    <td bgcolor="#047AC4">
                        <table width="95%" cellspacing="1" cellspacing="1" border="0" align="center">
                            <tr>
                                <td align="center"><font face="verdana, arial, helvetica" size=1>A ferramenta de cadastro e controle de Estoque</font></td>
                            </tr>

                        </table>
                    <table width="50%" cellspacing="1" cellspacing="3" border="0" bgcolor="#047AC4" align="center">
                        <tr>
                            <td bgcolor="#FFFFFF">
                                <table>
                                    <tr>
